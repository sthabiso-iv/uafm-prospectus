...
DocumentReference? get currentUserReference =>
    loggedIn ? ProspectusUsersRecord.collection.doc(currentUser!.uid) : null;

ProspectusUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ProspectusUsersRecord.getDocument(
                  ProspectusUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
